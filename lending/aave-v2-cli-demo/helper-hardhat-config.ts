...
import deployAdaptorsConfig from './api3-adaptors/config.json';
...
export const NETWORKS_RPC_URL: iParamsPerNetwork<string> = {
  ...
  [eEthereumNetwork.sepolia]: 'https://rpc2.sepolia.org',
  [eEthereumNetwork.custom]: deployAdaptorsConfig.network.rpc,
...
export const NETWORKS_DEFAULT_GAS: iParamsPerNetwork<number> = {
  ...
  [eEthereumNetwork.custom]: 65 * GWEI,
